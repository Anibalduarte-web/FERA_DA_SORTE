...
ARQUIVO_CSV = os.path.join(PASTA_PROJETO, "resultados_trilha_B.csv")
ARQUIVO_HTML = os.path.join(PASTA_PROJETO, "resultado_trilha_B.html")
...
def extrair_resultados_dia(url_dia, data_str):
    ...
    with open("pagina_recebida_trilha_B.html", "w", encoding="utf-8") as f:
        f.write(resp.text)

    print("HTML salvo em pagina_recebida_trilha_B.html")
    # =================
...
def salvar_resultados(resultados):
    ...
    try:
        ...
        print()
        print("ERRO: O arquivo resultados_trilha_B.csv está aberto.")
        print()
        input("Pressione ENTER para sair...")
        exit(1)
...
def gerar_html_bonito(resultados, data_str):
    """Gera resultado_trilha_B.html com layout visual moderno e emojis."""
